...
[0] = LAYOUT_ortho_5x12(
  ...
  MO(5),            KC_RALT,       KC_LALT,       KC_LGUI,       MO(2),         LALT_T(KC_ENT),  RGUI_T(KC_SPC),  MO(3),         KC_LEFT,       KC_DOWN,         KC_UP,            KC_RGHT
),
...
[2] = LAYOUT_ortho_5x12(
  ...
  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   MO(4),   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END
),
